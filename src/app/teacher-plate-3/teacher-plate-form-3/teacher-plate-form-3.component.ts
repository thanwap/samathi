...
@Component({
  selector: "app-teacher-plate-form-3",
  templateUrl: "./teacher-plate-form-3.component.html",
  styleUrls: ["./teacher-plate-form-3.component.scss"],
})
export class TeacherPlateForm3Component implements OnInit {
  chapters: IChapter[];
